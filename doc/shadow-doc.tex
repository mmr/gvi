%
% $Id: shadow-doc.tex,v 1.1.1.1 2004/11/25 13:41:57 mmr Exp $
% mmr <mmr@b1n.org> 
...
\chapter{Introdução}
Esse documento descreve a montagem e configuração do servidor de nomes secundário (slave) Shadow, por \href{http://cv.b1n.org/}{Marcio Ribeiro}, para a empresa \href{http://www.gvi.com.br/}{GlobalView Internet Services}.\\
...
\begin{tabular}{|p{4cm}|p{11cm}|}
  \hline \textbf{CPU}     & Intel Pentium III Xeon/Celeron 850MHz\\
  \hline \textbf{Memória} & 128Mb RAM\\
  \hline \textbf{HD}      & 1 HD Western Digital Caviar 1.500Mb (/dev/ad0*)\\
...
\begin{tabular}{|p{3.6cm}|p{3.6cm}|p{3.6cm}|p{3.6cm}|}
  ...
  \hline ad0s1a  & /     & UFS2 & 118Mb\\
  \hline ad0s1b  & swap  & swap   & 64Mb\\
  \hline ad0s1d  & /var  & UFS2+S & 50Mb\\
  \hline ad0s1e  & /tmp  & UFS2+S & 50Mb\\
  \hline ad0s1f  & /usr  & UFS2+S & 1.180Mb\\
  \hline
\end{tabular}

\subsection{Dificuldades Encontradas}
O particionamento do disco (descrito acima) foi feito de forma proporcional (deixando espaço suficiente para partição principal, /usr, comportar as árvores do ports e dos fontes).\\
Devido ao tamanho reduzido do disco, algumas partições, como a /var, ficaram pequenas (50Mb), comportando menos inodes\footnote{ inodes são ponteiros para arquivos, a quantidade de inodes em uma partição depende da densidade de bytes por inode. O padrão é $4\times2048$ bytes. Ou seja, uma partição de 50Mb, comportaria $(50\times1024\times1024)/(4\times2048) = 6400$ inodes, ou seja, 6400 arquivos de até 8kb.} do que o necessário para a função que essa partição desempenharia, que seria armazenar os arquivos de configuração e zonas do servidor de nomes, que, somados com os arquivos de log e outros naturais do /var, ultrapassariam 6400 facilmente. Por isso um diretório foi criado em /usr/named e um link simbólico foi feito de /var/named para /usr/named, retirando da partição /var os arquivos de configuração e zonas do Named.
